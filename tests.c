...
int test12() {
	...
	for(int i=0;i<8;i=i+1){
		...
		fifthblock[i]=rand();
        #ifdef PRINT_DEBUG
        printf("fifth block %i fourthblock %i\n",fifthblock[0],fourthblock[2]);
    ...
    printf("%i %i %i %i %i\n",firstblock[4],secondblock[4],thirdblock[4],fourthblock[4],fifthblock[4]);
    printf("%i %i %i %i %i\n",firstblock[5],secondblock[5],thirdblock[5],fourthblock[5],fifthblock[5]);
#endif
	}
